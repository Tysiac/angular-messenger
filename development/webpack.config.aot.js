          ...
          module: 
          {
                ...
                [
                  ...
                  // Extract css files
                    {
                        test: /\.css$/,
                        loader: 'style-loader',//isProduction?ExtractTextPlugin.extract({fallbackLoader: "style-loader",loader:["css-loader?sourceMap"]}):'style-loader!css-loader',//to-string-loader!css-loader',
                        include:[absSrc]
                    },
